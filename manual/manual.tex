...
\begin{document}
	...
	DNA2Graph supports 8-bit and 16-bit grayscale images if TIFF format.
	...
	\textbf{Examples:}
	\begin{itemize}
		\item \textit{Disconnected components.} An endpoint $e$ and a node $v$ are spatially close (their Euclidean distance is within $d_e$) and belong to distinct connected componets (their shortest-path distance is $\infty$). An edge $(e, v)$ is added, merging the two components.
	...
	\section{Trained Segmentation Piepeline (Beta)}
